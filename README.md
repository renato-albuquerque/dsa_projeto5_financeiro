...
A área de finanças é fundamental para o sucesso de uma empresa, pois é responsável por  gerenciar  os  recursos  financeiros  da  organização  e  garantir  que  esses  recursos  sejam utilizados de forma eficiente e eficaz para alcançar os objetivos da empresa. <br>

Algumas das principais funções da área de finanças de uma empresa incluem: <br>
...
## Principais KPIs da Área Financeira
...
A solução desenvolvida permitirá analisar os seguintes indicadores financeiros: <br>
...
### Sobre o Dataset
O dataset utilizado neste projeto contém informações financeiras organizadas por tipo de movimentação, componente financeiro, data e valor. Ele é composto por 432 registros, representando dados financeiros ao longo de diferentes períodos. <br>
...
![Dataviz solução projeto financeiro](files/dashboard_financeiro.PNG)
